...
function selectDh(dh)
{
    document.getElementById("Brower").setAttribute("class", "icon-box");
		...
		document.getElementById("Livi").setAttribute("class", "icon-box");
...
function selectTime(time)
{
    document.getElementById("Breakfast").setAttribute("class", "icon-box");
		...
		document.getElementById("Knight Room").setAttribute("class", "icon-box");
...
function buildQuery()
{
		//web scrape based on dining hall and time
		//fetch all items (meal name -> genres -> items -> ingredients)
		var items = [];
		var ingredients = [];
		let recipe = "";
